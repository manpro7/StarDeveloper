...
<html>
    <head>
        ...
        <!-- ============================== STYLESHEET - CSS ============================= -->
        <link rel="stylesheet" type="text/css" href="css/styleFakultasArdes.css">
    ...
    <div id="wrapper_faculty">
        <div id="faculty">
            ...
            <div id="wrapper_iklan_01">
                <div id="iklan_01">
                    <center>
                        <br><p>Fakultas Arsitektur dan Desain merupakan hasil dari pemekaran Fakultas Teknik, terdiri dari dua program studi yaitu Teknik Arsitektur dan Desain Produk. Resmi berdiri pada Oktober 2010 dengan semangat “nurture, innovate, conserve / nic” (baca: and I see).</p>
                    </center>
                </div>
            </div>
        </div>

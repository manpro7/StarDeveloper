...
<html>
    <head>
        ...
        <!-- ============================== STYLESHEET - CSS ============================= -->
        <link rel="stylesheet" type="text/css" href="css/styleFakultasBio.css">
    ...
    <div id="wrapper_faculty">
        <div id="faculty">
            ...
            <div id="wrapper_iklan_01">
                <div id="iklan_01">
                    <center>
                        <br><p>Fakultas Bioteknologi UKDW didirikan sebagai wujud kepedulian gereja-gereja yang mendukung Yayasan Perguruan Tinggi Kristen Duta Wacana untuk menghasilkan lulusan yang mampu memanfaatkan potensi sumber daya alam hayati dan bioteknologi dalam menanggulangi masalah-masalah lingkungan, industri dan kesehatan demi mewujudkan masyarakat yang sejahtera.</p>
                    </center>
                </div>
            </div>
        </div>

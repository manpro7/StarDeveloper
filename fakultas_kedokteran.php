...
<html>
    <head>
        ...
        <!-- ============================== STYLESHEET - CSS ============================= -->
        <link rel="stylesheet" type="text/css" href="css/styleFakultasKedok.css">
    ...
    <div id="wrapper_faculty">
        <div id="faculty">
            ...
            <div id="wrapper_iklan_01">
                <div id="iklan_01">
                    <center>
                        <br><p>Fakultas Kedokteran UKDW memiliki visi “Menjadi Fakultas Kedokteran yang menghasilkan generasi dokter profesional mandiri, unggul dan terpercaya dalam bidang pelayanan kesehatan primer untuk masyarakat pluralis berdasarkan kasih”.</p>
                    </center>
                </div>
            </div>
        </div>

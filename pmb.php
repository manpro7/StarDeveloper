...
<html>
	<head>
    	...
    	<!-- ============================== STYLESHEET - CSS ============================= -->
		<link rel="stylesheet" type="text/css" href="css/stylePmb.css">
	...
	<div id="wrapper_section">
		<div id="section">
			...
			<div id="tic_01_01">
				<p>Langkah - langkah pendaftaran Online Penerimaan Mahasiswa baru UKDW :
					<br>1. Silahkan melakukan daftar pada link di atas, kemudian ikuti petunjuk pendaftaran didalamnya. Penerimaan Mahasiswa Baru Online UKDW.
					<br>2. Anda akan mendapatkan sebuah nomor pendaftaran, digunakan sebagai login ke sistem. Nomor didapatkan pada link diatas.
					<br>3. Cermati setiap data yang akan anda inputkan dalam setiap form pendaftaran.
				</p>
			</div>
			<div id="tic_02">
				<h1>PMB UKDW OFFLINE</h1>
			</div>
			<div id="tic_02_01">
				<p>Langkah - langkah pendaftaran Penerimaan Mahasiswa baru UKDW :
					<br>1. Untuk pendaftaran secara offline ini, calon pendaftar dapat langsung menuju ke Kantor Humas dan Admisi UKDW, pada jam kerja.
					<br>2. Mengambil Formulir Pendaftaran di Kantor Humas dan Admisi pada hari Senin – Jumat (pukul 08.00-15.00 WIB) dan Sabtu (pukul 08.00-12.00 WIB).
					<br>3. Mengisi Formulir Pendaftaran dan membayar biaya pendaftaran.
					<br>4. Menyerahkan Formulir Pendaftaran dan perlengkapan syarat pendaftaran ke Kantor Humas dan Admisi UKDW, Jalan dr. Wahidin Sudirohusodo no. 5-25, Yogyakarta 55224.
				</p>
			</div>
		</div>
	</div>

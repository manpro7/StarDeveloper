...
<html>
    <head>
        ...
        <!-- ============================== STYLESHEET - CSS ============================= -->
        <link rel="stylesheet" type="text/css" href="css/styleFakultasTI.css">
    ...
    <div id="wrapper_faculty">
        <div id="faculty">
            ...
            <div id="wrapper_iklan_01">
                <div id="iklan_01">
                    <center>
                        <br><p>Pada tahun 2023 menjadi Fakultas yang unggul dan terpercaya di kawasan nasional untuk menghasilkan generasi profesional mandiri yang bertanggung-jawab dalam pengembangan ilmu pengetahuan dan Teknologi Informasi.</p>
                    </center>
                </div>
            </div>
        </div>

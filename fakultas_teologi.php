...
<html>
    <head>
        ...
        <!-- ============================== STYLESHEET - CSS ============================= -->
        <link rel="stylesheet" type="text/css" href="css/styleFakultasTeologi.css">
    ...
    <div id="wrapper_faculty">
        <div id="faculty">
            ...
            <div id="wrapper_iklan_01">
                <div id="iklan_01">
                    <center>
                        <br><p>Sekolah Tinggi Theologia Duta Wacana didirikan pada tahun 1962 sebagai hasil penggabungan dari 2 sekolah teologi yaitu Akademi Theologia Yogyakarta dan Sekolah Theologia Bale Wiyata Malang. Ketika Duta Wacana menjadi Universitas pada tahun 1985, Sekolah Tinggi Theologia Duta Wacana menjadi salah satu Fakultas dari Universitas Kristen Duta Wacana. Saat ini, Fakultas Teologi tetap merupakan bagian yang penting dari Universitas Kristen Duta Wacana (UKDW) dan tetap melanjutkan perannya sebagai lembaga pendidikan teologi yang terkemuka di Indonesia.</p>
                    </center>
                </div>
            </div>
        </div>
